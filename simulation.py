...
class Simulation:
    def __init__(self, idf, buildingPolygon, buildingArea, buildingHeight, buildingId,
                 ...
                 material_idf, df, hotWaterTemp, coldWaterTemp, 
                 maxFlowHotWater, buildingMainType, 
                 heatRecovery, heatRecoveryEffect, infFlow, dat):
    ...
    def building_idf (buildingPolygon, buildingArea, buildingHeight, buildingId, 
                      ...
                      buildingMainType, heatRecovery, heatRecoveryEffect, infFlow, dat):
        ...
        adj = Adjacency.adjacent_polygons(buildingPolygon, buildingId, dat)
        ...
        #HVAC.ideal_basement(idf, 10, heatRecovery, heatRecoveryEffect)
        ...
        Occupancy.people(idf,buildingArea, buildingHeight)
        Occupancy.equipment (idf, buildingArea, buildingHeight)
        Occupancy.dhw (idf, buildingArea, buildingHeight, hotWaterTemp, 
                       coldWaterTemp, maxFlowHotWater)
        return idf
